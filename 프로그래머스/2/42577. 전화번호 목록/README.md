...
### 접근 방법
- 배열 정렬: 정렬 시 접두사 관계가 있는 번호들끼리는 연속해서 붙어 나옴 -> 전체를 볼 필요 없이 옆에 붙어있는 요소만 보면 됨
- `startsWith()` 함수 사용: 다음 요소가 현재 요소로 시작하는지 여부 확인
